...
interface MultiSigInterface {
     ...
     */ 
    event SetSigMin(uint256 oldSigsMin, uint sigsMin, uint256 date);
     ...
     * - address newMember
     */
    function addCommiteeMember(address newMember) external;
     ...
     * - address newMember
     */
    function removeCommiteeMember(address newMember) external;
     ...
     * - uint newSigsMin
     */
    function setSigMin(uint256 newSigsMin) external;
}